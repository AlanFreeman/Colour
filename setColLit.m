function m = setColLit(m) % set Colour metadata calculated from the literature
	...
	m.p.actRest = [21.8, 25.4]; % resting gang. cell impulse rate (Hz), [off, on]
		% Troy (94)
	...
	m.p.radBackCoef = [-1.2182, 1.4147, 27.066, 14.479]; % feedback c.f. radius
		% Wässle (89), Packer (02)
		% f'back convergence fun. radius (deg) = 10 ^ (c1 + c2 * normcdf(e, c3, c4))
